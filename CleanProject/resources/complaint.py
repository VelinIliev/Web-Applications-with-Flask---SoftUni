...
from schemas.request_scheams.complaints import ComplaintRequestSchema
...
class ComplaintResources(Resource):
    def get(self, pk):
        pass
...
class ComplaintApproveResources(Resource):
    @auth.login_required
...
class ComplaintRejectResources(Resource):
    @auth.login_required
    @permission_required(RoleType.approver)
    def get(self, pk):
